import { Clock, Package, CreditCard, Eye, ArrowRight } from "lucide-react";
...
const recentActivity = [
  {
    icon: Package,
    text: 'New product "Velvet Abaya" was added',
    time: "30 min ago",
  },
  {
    icon: CreditCard,
    text: "Payment of $389.00 received from Sara",
    time: "1 hr ago",
  },
  {
    icon: Eye,
    text: "12 new virtual try-ons on Silk Evening Gown",
    time: "2 hrs ago",
  },
  {
    icon: Package,
    text: "Stock updated for Cashmere Wrap Dress",
    time: "4 hrs ago",
  },
];
